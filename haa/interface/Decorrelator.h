//https://github.com/cms-analysis/HiggsAnalysis-CombinedLimit/blob/102x/interface/Decorrelator.h
...
class Decorrelator {
    public:
        Decorrelator(const char *name, RooWorkspace *w, RooFitResult &result);
...
Decorrelator::Decorrelator(const char *name, RooWorkspace *w, RooFitResult &result) :
    name_(name),
...
RooAbsPdf *Decorrelator::diagonalize(RooAbsPdf &pdf)
{
